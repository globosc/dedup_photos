...
def encontrar_fotos_duplicadas(ruta_base, archivos_movidos):
    ...
    for ruta_archivo in tqdm(list(ruta_base.rglob('*')), desc="Procesando archivos"):
...
def main():
    ruta_base = Path("/ruta/a/tu/carpeta_de_fotos")  # Reemplaza con la ruta de tu carpeta de fotos
    carpeta_duplicados = ruta_base / "Duplicados"
